            ...
            children: [
              Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      hController.selectedIndex.value =
                          hController.indexPage.length - 1;
                    },
                    child: CircleAvatar(
                      backgroundImage: NetworkImage("${hController.domainUrl}/${hController.userData['poto_profil'] ?? "static/image/default-person.jpg"}"),
                  ...
                  Column(
                    ...
                    children: [
                      Text(hController.userData['noKK'] ?? "Nomor KK",
                          style: montserrat600(16, black)),
                      Text(
                          '${hController.userData['jabatan']} - RT ${hController.userData['rt']} RW ${hController.userData['rw']}',
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    controller.weatherData['conditionText'] ??
                                        "TIdak terkoneksi jaringan",
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.history,
                                        size: 20, color: abudebu),
                                    SizedBox(width: 4.w),
                                    Text(
                                      controller.weatherData['localtime'] ??
                                          "TIdak terkoneksi jaringan",
